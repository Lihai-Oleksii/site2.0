...
$(function () {
  ...
  var preloader = (function () {
    ...
    var setPersents = function (total, current) {
      ...
      var strokeDasharray = parseInt($('.preloader__circle circle').css('stroke-dasharray'));

    
      $('.preloader__circle circle').css({
        'stroke-dashoffset': strokeDasharray - (persents * strokeDasharray / 100)
      }, 100);
...
$(function() {
  ...
  document.addEventListener('wheel', function(e) {
    ...
    if (!$(target).parents('.swiper-container').hasClass('partners-list')) return;
    var area = target;
  ...
  $('.format-tab__item').on('click', function(e) {
    ...
    var nextElem = $('.contents-for-tabs').find('.tab-content')[indexActiveElem];
...
$(function() {
  ...
  $(window).scroll(function() {
    ...
    var scrollEvent = (w_top + 500 >= e_top || w_height + w_top == d_height || e_height + e_top < w_height);
...
$(function () {
  ...
  (function () {
    ...
    $('.js-validate-form').each(function () {
      ...
      $(this).append("<input type=\"hidden\" name=\"".concat(name, "\" class=\"js-input-seconds\" value=\"0\" />"));
    });
